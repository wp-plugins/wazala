...
We designed Wazala to allow a seamless integration with any website. The overlay will dim the background and light up the store to allow for a compatible look with your existing site design.
...
Activate Wazala in the "Plugins" admin panel using the "Activate" link.
